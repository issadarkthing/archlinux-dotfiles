...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    -- launch dmenu
    , ((modm, xK_d), spawn "/home/terra/.config/rofi/launchers/type-4/launcher.sh")
    ...
    -- switch between two recent workspace
    , ((altKey, xK_Tab), toggleWS)

    -- close dunst notification
    , ((mod1Mask, xK_space), spawn "dunstctl close all")
    ...
    -- screenshot utility
    , ((0,  xK_Print), spawn $ scripts ++ "snap.sh")
    ...
    -- Toggle status bar
    , ((modm .|. altKey, xK_b), sendMessage ToggleStruts >> spawn "polybar-msg cmd toggle")
...
myStartupHook = do
    ...
    spawnOnce "picom -b &"
    spawnOnce "feh --bg-scale ~/Pictures/artix-bg.png &"
...
--
main = do
    xmproc <- spawnPipe "~/.config/polybar/launch.sh --cuts"
